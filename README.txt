...
==========================================================================	
		...
		3.	Go to the command prompt and go to the directory containing the source code then type :
			- "PATH\Rscript" <<File_R>> <<minSupp>> <<minimum_size_of_gradual_pattern>> <<output_file>> <<K1>> <<K2>> <<column_separator_in_the_dataset>> <<windows>>
										<<num_date>> <<num_product>> <<num_quantite>> <<num_user>> <<TopN>> <<Cluster>>
			- where K1 and K2 are constants
			
			-	"PATH\Rscript" <<File_R>> <<minSupp>> <<minimum_size_of_gradual_pattern>> <<output_file>> <<K1>> <<K2>> <<column_separator_in_the_dataset>> <<windows>> 
										  <<num_date>> <<num_product>> <<num_quantite>> <<num_user>> <<TopN>> <<Cluster>> <<MinDisc>>
			- 
		   Exemple :
				- 	Rscript GP-RRC.R  
